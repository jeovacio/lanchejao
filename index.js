...
naoBtn.addEventListener("mouseover", () => {
  attempts++;
  if (attempts >= 5) {
    mensagem.innerText = "Vaaaaaai sim, tira o carangueijo do bolso e paga!";
  }
...
simBtn.addEventListener("click", function(){
  mensagem.innerText = "Não acredito que tu clicou em SIM!!! Aeeeeeee caraiiii";
  setTimeout(() => {
    window.location.href = "https://www.yout-ube.com/watch?v=xFrGuyw1V8s&list=PLkvxeByksjsztjvcXVp-vla09bSG_TrKH&index=2"; // Coloque o link do vídeo desejado aqui
  }, 2000);
});
